#!/usr/bin/env python3
"""CUA smoke test for NSIS-installed fleet apps (godot-mcp).
...
NSIS_GLOB = cfg("nsis_glob", "webapp/src-tauri/target/release/bundle/nsis/Pywinauto MCP Operator_*_x64-setup.exe")
