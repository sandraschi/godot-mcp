...
4. Start the server:
   ...
   uv run uvicorn godot_mcp.server:app --port 10993
   ```
5. Open `http://localhost:10993` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/godot-mcp/issues) |
